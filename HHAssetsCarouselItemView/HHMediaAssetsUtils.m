...
#import "UICollectionView+HHUtils.h"

#import "TGMediaSelectionContext.h"

@interface HHMediaAssetsPreheatMixin ()
{
...
@implementation HHMediaAssetsPreheatMixin
...
- (void)update
{
    ...
    if (delta > threshold)
    {
        ...
        __weak HHMediaAssetsPreheatMixin *weakSelf = self;
        ...
        {
            __strong HHMediaAssetsPreheatMixin *strongSelf = weakSelf;
            if (strongSelf == nil)
                return;
...
@implementation HHMediaAssetsCollectionViewIncrementalUpdater
