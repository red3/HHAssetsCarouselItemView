...
#import "HHModernGalleryTransitionView.h"

NSString *const HHAttachmentPhotoCellIdentifier = @"AttachmentPhotoCell";

@interface HHAttachmentPhotoCell () <TGModernGalleryTransitionView>

@end

@implementation HHAttachmentPhotoCell
...
- (UIImage *)transitionImage
{
    ...
    [[UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height) cornerRadius:HHAttachmentMenuCellCornerRadius] addClip];
